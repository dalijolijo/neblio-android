...
//                + " existing key " + io.limx.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + io.limx.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != io.limx.core.coins.nxt.Crypto.rsDecode(io.limx.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = io.limx.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = io.limx.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = io.limx.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, io.limx.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(io.limx.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = io.limx.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
